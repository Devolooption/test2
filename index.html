...
<!--[if (gt IEMobile 7)|!(IEMobile)]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
    	...
    	<video width="50%" height="50%" controls>
    	  ...
    	  <object data="videos/carnival.mp4" width="50%" height="50%">
    	    <!--<embed src="movie.swf" width="50%" height="50%">-->
    	  </object>
    
         <track src="greet.vtt" kind="subtitles" srclang="no" label="English">
    </video>
	<h6 style="margin-left:20%;">(Available in Closed-Caption)</h6>
